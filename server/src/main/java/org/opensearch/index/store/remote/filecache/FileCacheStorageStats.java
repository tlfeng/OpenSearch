 ...
 * @opensearch.internal
 */
public class FileCacheStorageStats implements Writeable, ToXContentFragment {
    ...
    public FileCacheStorageStats(final StreamInput in) throws IOException {
