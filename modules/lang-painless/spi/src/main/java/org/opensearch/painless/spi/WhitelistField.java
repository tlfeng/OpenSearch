...
public class WhitelistField {
    ...
    final AllowlistField allowlistField;
    ...
    public WhitelistField(String origin, String fieldName, String canonicalTypeNameParameter, List<Object> painlessAnnotations) {
        allowlistField = new AllowlistField(origin, fieldName, canonicalTypeNameParameter, painlessAnnotations);
        this.origin = allowlistField.origin;
        this.fieldName = allowlistField.fieldName;
        this.canonicalTypeNameParameter = allowlistField.canonicalTypeNameParameter;
        this.painlessAnnotations = allowlistField.painlessAnnotations;
    }
}
