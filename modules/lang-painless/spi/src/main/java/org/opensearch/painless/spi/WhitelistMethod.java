 ...
 * allowlisted.
 *
 * @deprecated As of 2.2, because supporting inclusive language, replaced by {@link #}
 */
@Deprecated
public class WhitelistMethod {

    final AllowlistMethod allowlistMethod;
    ...
    public WhitelistMethod(
        ...
        allowlistMethod = new AllowlistMethod(
            origin,
        ...
        this.origin = allowlistMethod.origin;
        this.augmentedCanonicalClassName = allowlistMethod.augmentedCanonicalClassName;
        this.methodName = allowlistMethod.methodName;
        this.returnCanonicalTypeName = allowlistMethod.returnCanonicalTypeName;
        this.canonicalTypeNameParameters = allowlistMethod.canonicalTypeNameParameters;
        this.painlessAnnotations = allowlistMethod.painlessAnnotations;
    }
}
