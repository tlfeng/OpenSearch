...
public final class WhitelistConstructor {
    ...
    final AllowlistConstructor allowlistConstructor;
    ...
    public WhitelistConstructor(String origin, List<String> canonicalTypeNameParameters, List<Object> painlessAnnotations) {
        allowlistConstructor = new AllowlistConstructor(origin, canonicalTypeNameParameters, painlessAnnotations);
        this.origin = allowlistConstructor.origin;
        this.canonicalTypeNameParameters = allowlistConstructor.canonicalTypeNameParameters;
        this.painlessAnnotations = allowlistConstructor.painlessAnnotations;
    }
}
